...
const INDUSTRIES: Industry[] = [
  {
    emoji: "🛍️",
    bg: "linear-gradient(145deg,#0f1a35,#1a2d5a,#0a3d7a)",
  ...
  {
    emoji: "📦",
    bg: "linear-gradient(145deg,#0f2010,#163d20,#1a5c30)",
  ...
  {
    emoji: "🚢",
    bg: "linear-gradient(145deg,#1a1200,#3d2800,#5c3a00)",
    title: "Import / Export",
  ...
  {
    emoji: "🏭",
    bg: "linear-gradient(145deg,#0a1f30,#123450,#1a4d6e)",
    title: "3PL Providers",
  ...
  {
    emoji: "🚛",
    bg: "linear-gradient(145deg,#1a0d00,#3d2000,#5c3300)",
  ...
  {
    emoji: "⚙️",
    bg: "linear-gradient(145deg,#0d0d2e,#1a1a4d,#1e226e)",
  ...
  {
    emoji: "🥡",
    bg: "linear-gradient(145deg,#0d1a0a,#1a3d12,#225c18)",
    title: "Food & Beverage",
  ...
  {
    emoji: "🎪",
    bg: "linear-gradient(145deg,#1a0a1a,#3d1a3d,#5c2260)",
  ...
  {
    emoji: "🎙️",
    bg: "linear-gradient(145deg,#0a0a1a,#1a1a3d,#26165c)",
  ...
  {
    emoji: "🏛️",
    bg: "linear-gradient(145deg,#0d1a1a,#163333,#1a4d4d)",
  ...
  {
    emoji: "📬",
    bg: "linear-gradient(145deg,#0f0a1a,#1e1035,#2d1850)",
        ...
        <div className="overflow-hidden">
          ...
          >
            {INDUSTRIES.map((ind) => (
              <article
                key={ind.title}
                className="flex flex-col overflow-hidden rounded-lg shadow-lg shadow-navy/10"
                style={{
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-navy-dark/55" />
                </div>
