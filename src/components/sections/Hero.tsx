    ...
    <section className="relative isolate overflow-hidden bg-navy-dark pt-16">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-start gap-12 px-6 py-16 lg:grid-cols-[minmax(0,1fr)_460px] lg:gap-16 lg:px-12 lg:py-20">
        <div className="text-white">
          ...
          <h1 className="animate-fade-up mt-6 font-display text-4xl font-black leading-[1.02] tracking-tight text-white text-balance sm:text-5xl lg:text-6xl xl:text-[4.25rem]">
            On-Demand Warehouse Space.
            <br />
            <span className="text-green-light">Expand or Downsize Anytime.</span>
          </h1>

          <p className="animate-fade-up mt-6 max-w-xl text-lg leading-relaxed text-white/75 sm:text-xl">
            No long-term lease. No build-out.
            <br />
            All-in pricing across{" "}
            <span className="font-semibold text-green-light">50+</span> locations in{" "}
            <span className="font-semibold text-green-light">22 states</span>.
          </p>
